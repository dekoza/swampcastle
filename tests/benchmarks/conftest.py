...
def config_dir(tmp_path):
    """Isolated config directory for monkeypatching CastleConfig."""
    d = tmp_path / "config"
    d.mkdir()
    config = {"palace_path": str(tmp_path / "palace"), "collection_name": "swampcastle_chests"}
...
def pytest_terminal_summary(terminalreporter, config):
    ...
    results_file = os.path.join(tempfile.gettempdir(), "swampcastle_bench_results.json")
