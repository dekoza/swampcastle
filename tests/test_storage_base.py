...
class TestGraphStoreABC:
    ...
    def test_complete_subclass_ok(self):
        class Complete(GraphStore):
            def add_entity(self, *, name, entity_type="unknown", properties=None): pass
            def add_triple(self, *, subject, predicate, obj, valid_from=None,
                           valid_to=None, confidence=1.0, source_closet=None,
                           source_file=None): pass
            def query_entity(self, *, name, as_of=None, direction="outgoing"): pass
            def query_relationship(self, *, predicate, as_of=None): pass
            def invalidate(self, *, subject, predicate, obj, ended=None): pass
            def timeline(self, *, entity_name=None): pass
            def stats(self): pass
            def close(self): pass
