# Contributing to SwampCastle

Thanks for wanting to help. SwampCastle is open source and we welcome contributions of all sizes — from typo fixes to new features.
...
```
swampcastle/          ← core package (see swampcastle/README.md for module guide)
...
Check the [Issues](https://github.com/dekoza/swampcastle/issues) tab. Great starting points:
