# swampcastle/ — Core Package

The Python package that powers SwampCastle. All modules, all logic.
...
| `config.py` | Configuration loading — `~/.swampcastle/config.json`, env vars, defaults |
