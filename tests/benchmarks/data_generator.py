"""
Deterministic data factory for SwampCastle scale benchmarks.
...
class PalaceDataGenerator:
    ...
    def generate_project_tree(self, base_path, wing=None, rooms=None, n_files=50):
        """
        Write realistic project files + swampcastle.yaml to base_path.
